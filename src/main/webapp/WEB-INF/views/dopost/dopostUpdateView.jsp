...
<form action = "dopostUpdate.do" method = "post">
<input type = "hidden" name="dno" value="${dopost.dno }">								
<tr>
<td align="center">${ dopost.dno }</td>

<td>
<input type = "text" name="dtitle" value="${ dopost.dtitle }">

</td>
<td align="center">${ dopost.ducode }</td>
<td align="center">${ dopost.dwriter }</td>
<td align="center"> <textarea  name="dcontent" col rows="3" cols="50">${ dopost.dcontent }</textarea> </td>
...
<input type ="button" value="이전페이지로이동" onclick="javascript:history.go(-1); return false;">
</td>
</tr>			
</form>					
								</table>
